...
const toimitus = document.getElementById('toimitus')
const form = document.getElementById('form')
const maksuehdot = document.getElementById('maksuehdot')
const errorElement = document.getElementById('error')

form.addEventListener('submit', (e) =>{
    let messages = []
    if (toimitus.value !== 'Kyllä' && toimitus.value !== 'Ei'){
        alert('Toimituksessa jompikumpi on valittava. Tarkistathan onko kirjoitettu isolla')
        e.preventDefault()
    }
    if (maksuehdot.value !== 'Kyllä'){
